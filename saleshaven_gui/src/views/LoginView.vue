            ...
            <form @submit.prevent="userLogin">
              <div class="inputs">
                ...
                <input type="email" oninvalid="this.setCustomValidity('Please enter your email address')"
                  oninput="this.setCustomValidity('')" class="email" name="email" v-model="email" placeholder="Email">
                <label for="password">Password</label>
                <input type="password" oninvalid="this.setCustomValidity('Please enter your password')"
                  oninput="this.setCustomValidity('')" class="email" name="password" v-model="password"
